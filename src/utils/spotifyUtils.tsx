...
export const pause = (player: Merger.SpotifyPlayer | null): Promise<Response> | undefined => {
    if (player !== null) {
...
export const play = (player: Merger.SpotifyPlayer | null, spotify_uris: string[]): Promise<Response> | undefined => {
  if (player !== null) {
    player.spotify._options.getOAuthToken((access_token: string) => {
      if (player.deviceId !== null) {
